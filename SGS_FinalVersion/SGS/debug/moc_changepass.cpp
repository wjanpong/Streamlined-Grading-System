...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_changePass_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 26, 29), // "on_pushButton_confirm_clicked"
QT_MOC_LITERAL(5, 56, 11), // "receiveData"
QT_MOC_LITERAL(6, 68, 26) // "on_pushButton_back_clicked"

    },
    "changePass\0sendData\0\0data\0"
    "on_pushButton_confirm_clicked\0receiveData\0"
...
void changePass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (changePass::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&changePass::sendData)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject changePass::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_changePass.data,
...
void *changePass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_changePass.stringdata))
...
// SIGNAL 0
void changePass::sendData(QString _t1)
{
